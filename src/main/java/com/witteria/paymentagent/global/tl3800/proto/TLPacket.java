...
import static com.witteria.paymentagent.global.tl3800.proto.Proto.CATMID_LEN;
import static com.witteria.paymentagent.global.tl3800.proto.Proto.DATETIME_LEN;
import static com.witteria.paymentagent.global.tl3800.proto.Proto.ETX;
...
/**
 * @param catOrMid Header 16 ASCII, 좌측정렬, 우측 0x00 패딩
 * @param dateTime14 14 ASCII (YYYYMMDDhhmmss)
 * @param jobCode 1 byte
 * @param responseCode 1 byte, 요청 시 항상 0x00
 * @param data 가변
 * @param etx Tail 0x03
 */
public record TLPacket(
  ...
  public static TLPacket parseLenient(byte[] frame) {
    ...
    int actualDataLen = Math.min(dataLen, maxDataArea);
